...
class ReceiveAvailableConnectionsTemplate(
    _ReceiveAvailableConnectionsMessageBase, Template
):
    pass


class ReceiveAvailableConnectionsMessage(
    _ReceiveAvailableConnectionsMessageBase, Message
):
    pass
